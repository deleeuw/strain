...
The problem of minimizing strain over $\Delta$ for fixed $D^2$ can be written in vector form, by using the $\text{vec}()$ of $\Delta$ and $D^2$, and by using the 
...
Without loss of generality we require that the data are ordered such that the elements of $\delta$ must be increasing.
...
Write $\delta=\tilde\delta+(\delta-\tilde\delta)$ and
expand strain around $\tilde\delta$.
\begin{equation}
\sigma(\delta)=\sigma(\tilde\delta)+\frac12(\delta-\tilde\delta)'J\otimes J(\tilde\delta-d^2)+\frac14(\delta-\tilde\delta)'J\otimes J(\delta-\tilde\delta)\}, 
\end{equation}
Because $J\otimes J\lesssim I$ we have
$\sigma(\delta)\leq\eta(\delta,\tilde\delta)$
with
\begin{equation}
\eta(\delta,\tilde\delta):=\sigma(\tilde\delta) +\frac12(\delta-\tilde\delta)'J\otimes J(\tilde\delta-d^2) +\frac14(\delta-\tilde\delta)'(\delta-\tilde\delta)
\end{equation}
...
\begin{equation}
\eta(\delta,\tilde\delta):=\sigma(\tilde\delta)+\frac14(\delta-\hat\delta)'(\delta-\hat\delta)-\frac14(\tilde\delta-d^2)'J\otimes J(\tilde\delta-d^2)
\end{equation}
with
$$
\hat\delta:=\tilde\delta-(J\otimes J)(\tilde\delta-d^2)=(I-(J\otimes J))\tilde\delta+(J\otimes J)d^2,
$$
where the last expression shows $\hat\delta$ is a matrix-weighted average
of the "conservative" part $\tilde\delta$
and the "progressive" part $d^2$ (@chamberlain_leamer_76). Finally the update $\delta^+$ is the least squares projection of $\hat\delta$ on the cone, i.e. the unweighted monotone regression on $\hat\delta$.
$$
\sigma(\delta^+)\leq\eta(\delta^+,\tilde\delta)\leq\eta(\tilde\delta,\tilde\delta)=\sigma(\tilde\delta)
$$
...
Switching back to matrices definition ... becomes
$$
\hat\Delta:=\tilde\Delta-J(\tilde\Delta-D^2)J.
$$
