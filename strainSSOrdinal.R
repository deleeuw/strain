...
strainSSOrdinal <- function(theData,
  ...
  repeat {
    ...
    h <- as.vector(doubleCenterSS(dhat - dnew^2))
    snew <- sum(h^2) / 4
    if (verbose) {
      cat(
        " itel ",
